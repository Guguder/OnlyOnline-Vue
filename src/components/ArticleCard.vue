  ...
  <div class="w-full bg-white p-4 flex gap-4">
    ...
    <div class="flex-grow flex flex-col justify-between">
      <div class="flex flex-col w-full">
        ...
        <h2 class="text-base font-semibold leading-tight text-[#000000] text-left mb-2">{{ article.title }}</h2>
        <p class="text-sm leading-normal text-gray-600 truncate text-left">{{ article.content }}</p>
      </div>
