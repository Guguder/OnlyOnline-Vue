  ...
  <div class="w-screen min-h-screen flex justify-center gap-[20px] mt-[20px] mb-[40px]">
    ...
    <div class="w-[840px]">
      ...
      <div class="w-full bg-white rounded-2xl p-5">
        <!-- 学习计划区域 -->
        <h2 class="text-2xl font-bold text-gray-700 mb-6 text-left">学习计划</h2>
            ...
            <div class="flex items-center">
              <span v-if="nav.id === 'all'" class="w-4 h-4 mr-2">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 4H5a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1Z" stroke="currentColor"
              ...
              <span v-else :class="nav.iconClass" class="mr-2">{{ nav.icon }}</span>
              {{ nav.text }}
            </div>
          </button>
        </div>
        ...
        <!-- 将原来的题目列表替换为新组件 -->
        <div class="mt-6"> <!-- 添加这个包装 div 来增加间距 -->
...
const cardDataList = [
  ...
  },
  {
    icon: "HOT",
    title: "热门框架深度剖析",
    description: "从源码角度理解热门框架，提升核心竞争力心竞争力心竞争力心竞争力心竞争力",
  },
  {
    icon: "JS",
    title: "JavaScript 面试指南",
    description: "从基础到进阶，深入探讨 JavaScript 面试问题面试问题面试问题面试问题面试问题",
  },
  {
    icon: "DB",
    title: "数据库面试解析",
...
const navItems = [
  ...
  {id: 'javascript', text: 'JavaScript', icon: 'JS', iconClass: 'text-blue-400'}
];
